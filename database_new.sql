-- ============================================================
--  Einkauf-Portal – Neue Datenbank
--  Datenbank: testing
--  Benutzer:  nico
--  Passwort:  JICSbKNPgI8I0vwX79hg
--
...
CREATE USER IF NOT EXISTS 'nico'@'localhost' IDENTIFIED BY 'JICSbKNPgI8I0vwX79hg';
GRANT ALL PRIVILEGES ON `testing`.* TO 'nico'@'localhost';
FLUSH PRIVILEGES;

-- Ab jetzt in der neuen Datenbank arbeiten
USE `testing`;
...
CREATE TABLE IF NOT EXISTS `invoices` (
    ...
    `shopping_fee`         INT           NOT NULL DEFAULT 0 COMMENT 'Cent',
    `total`                INT           NOT NULL DEFAULT 0 COMMENT 'Cent',
    `status`               ENUM('offen','teilbezahlt','bezahlt','überfällig','storniert') NOT NULL DEFAULT 'offen',
...
-- ============================================================
--  INITIALDATEN
--  Admin-Account: Benutzername "Admin", PIN 1234
--  PIN sofort nach dem ersten Login ändern!
-- ============================================================
INSERT INTO `users`
    (`family_name`, `role`, `rank`, `pin_hash`)
VALUES
    ('Admin', 'admin', 6, '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi');
...
-- ============================================================
--  ZUGANGSDATEN FÜR config/config.php:
--
--    $dbName = 'testing';
--    $dbUser = 'nico';
--    $dbPass = 'JICSbKNPgI8I0vwX79hg';
--
--  Erster Login:
--    Benutzername: Admin
--    PIN:          1234   ← sofort ändern!
-- ============================================================
